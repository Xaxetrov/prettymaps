...
def plot(
    ...
    if mode == "matplotlib":
        ...
        if title:
            ...
            plt.text(np.interp([0.02], [0, 1], [xmin, xmax])[0],np.interp([0.5], [0, 1], [ymin, ymax])[0],"Generated by Edern on 2023/08/08", rotation='vertical', verticalalignment='center', size=16, fontproperties = fp)
